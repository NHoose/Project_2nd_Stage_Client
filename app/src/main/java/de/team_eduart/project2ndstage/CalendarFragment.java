...
public class CalendarFragment extends Fragment implements OnClickListener {
    ...
    public void onCreate (){
        ...
        selectedDayMonthYearButton = (Button) getView().findViewById(R.id.selectedDayMonthYear);
        ...
        calendarView = (GridView) getView().findViewById(R.id.gridCalendar);
    ...
    public class GridCellAdapter extends BaseAdapter implements OnClickListener {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (day_color[1].equals("BLUE")) {
                gridcell.setTextColor(getResources().getColor(R.color.blue_200));
            }
            return row;
        }
